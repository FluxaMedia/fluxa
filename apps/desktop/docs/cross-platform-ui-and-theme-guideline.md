...
| iOS | `apps/android` / `apps/apple` | Compose Multiplatform host and Swift platform integration | UniFFI and generated Swift |
| tvOS | `apps/android` / `apps/apple` | Native SwiftUI visual shell with shared KMP/core contracts | UniFFI and KMP data modules |
| Desktop, browser, webOS | `apps/desktop` | React UI, Tauri shell, native desktop player, browser/webOS adapters | Direct Rust, WASM, Tauri |
