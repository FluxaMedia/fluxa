  ...
  return (
    <header style={styles.header}>
      ...
      <div style={styles.monthControls}>
        ...
        <button style={styles.navBtn} onClick={() => onMonthChange(shiftMonth(monthStart, 1))} aria-label={t('calendar.next_month')}>
      ...
      <div style={styles.actions}>
        ...
        <button
          ...
          aria-label={showCompleted ? t('calendar.hide_completed') : t('calendar.show_completed')}
        >
