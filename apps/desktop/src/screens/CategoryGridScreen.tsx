...
const S: Record<string, React.CSSProperties> = {
  ...
  header: {
    ...
    padding: '1rem 1.5rem',
    flexShrink: 0,
    borderBottom: '1px solid var(--fluxa-border)',
  },
  backBtn: {
    width: '2.25rem',
    height: '2.25rem',
...
const DP: Record<string, React.CSSProperties> = {
  ...
  bgFade: { position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, transparent 0%, var(--fluxa-surface) 100%)' },
  content: { position: 'relative', zIndex: 1, padding: '11.25rem 1.25rem 2rem', display: 'flex', flexDirection: 'column', flex: 1 },
  title: { color: 'var(--fluxa-text-primary)', fontSize: '1.625rem', fontWeight: 900, margin: '0 0 0.625rem', lineHeight: 1.1, letterSpacing: '-0.0187rem' },
  metaRow: { display: 'flex', alignItems: 'center', gap: '0.875rem', marginBottom: '0.875rem', flexWrap: 'wrap' },
  metaItem: { color: 'var(--fluxa-text-secondary)', fontSize: '0.8125rem', fontWeight: 600 },
  imdbBadge: {
    display: 'flex',
    alignItems: 'center',
    gap: '0.25rem',
  ...
  genreChip: { color: 'var(--fluxa-text-secondary)', fontSize: '0.8125rem' },
  castName: { color: 'var(--fluxa-text-secondary)', fontSize: '0.8125rem' },
