...
export function PlaybackSection({ prefs, setPref }: { prefs: Prefs; setPref: <K extends keyof Prefs>(k: K, v: Prefs[K]) => void }) {
  ...
  useEffect(() => {
    ...
    void invoke<Array<{ id: string; label: string }>>('external_player_options')
      .then(setExternalPlayers)
      .catch(() => setExternalPlayers([]));
  }, [browserTarget]);
  ...
  useEffect(() => {
    if (!browserTarget) refreshCustomFonts();
  }, [browserTarget]);
  ...
  return (
    <>
      <SettingsSection title={t('auto.playback_dbc1ddba')} subtitle={t('auto.player_behavior_and_defaults')}>
        ...
        {!browserTarget && (
          <ChoiceTile
            title={t('settings.preferred_player')}
            subtitle={t('settings.preferred_player_desc')}
            options={[
              { value: 'mpv', label: t('settings.player_internal') },
              { value: 'external', label: t('settings.player_external') },
            ]}
            selected={prefs.preferredPlayer}
            onSelect={(v) => setPref('preferredPlayer', v)}
          />
        )}
        {!browserTarget && prefs.preferredPlayer === 'external' && (
          <>
            <ChoiceTile
              title={t('settings.external_player')}
              subtitle={t('settings.external_player_desc')}
              options={[
                ...externalPlayers.map((player) => ({
                  value: player.id,
                  label: player.id === 'system' ? t('settings.system_default') : player.label,
                })),
                ...(externalPlayers.some((player) => player.id === prefs.externalPlayerTarget)
                  ? []
                  : [{ value: prefs.externalPlayerTarget, label: prefs.externalPlayerTarget }]),
              ]}
              selected={prefs.externalPlayerTarget}
              onSelect={(v) => setPref('externalPlayerTarget', v)}
            />
            <ActionTile
              title={t('settings.external_player_choose')}
              subtitle={t('settings.external_player_choose_desc')}
              icon={<Type size={18} />}
              onClick={() => void chooseExternalPlayer()}
            />
          </>
        )}
        <ChoiceTile
        ...
        />
        <ToggleTile
          title={t('settings.hold_to_speed')}
          subtitle={t('settings.hold_to_speed_desc')}
          checked={prefs.holdToSpeedEnabled}
          onToggle={(v) => setPref('holdToSpeedEnabled', v)}
        />
        <ChoiceTile
          ...
          options={[
            ...
            { value: '2.5', label: '2.50x' },
            { value: '3.0', label: '3.00x' },
          ]}
      ...
      <SettingsSection title={t('settings.stream_settings')} subtitle={t('settings.stream_source_selection_desc')}>
        ...
        <ToggleTile
          title={t('settings.auto_retry_next_source')}
          subtitle={t('settings.auto_retry_next_source_desc')}
          checked={prefs.autoRetryNextSource}
          onToggle={(v) => setPref('autoRetryNextSource', v)}
        />
        <ToggleTile
          title={t('settings.auto_play_next_episode')}
          subtitle={t('settings.auto_play_next_episode_desc')}
          checked={prefs.autoPlayNextEpisode}
          onToggle={(v) => setPref('autoPlayNextEpisode', v)}
        />
        ...
        <ToggleTile
          title={t('settings.try_binge_group')}
          subtitle={t('settings.try_binge_group_desc')}
          checked={prefs.tryBingeGroup}
          onToggle={(v) => setPref('tryBingeGroup', v)}
        />
        <SliderTile
          title={t('settings.next_episode_threshold')}
          subtitle={t('settings.next_episode_threshold_desc')}
          value={Number(prefs.nextEpisodeThresholdPercent)}
          min={50}
          max={95}
          step={5}
          onChange={(v) => setPref('nextEpisodeThresholdPercent', String(v))}
        />
        <SliderTile
          title={t('settings.watched_threshold')}
          subtitle={t('settings.watched_threshold_desc')}
          value={Number(prefs.watchedThresholdPercent)}
          min={60}
          max={100}
          step={5}
      ...
      <SettingsSection title={t('settings.advanced')} subtitle={t('settings.buffer_cache_desc')}>
        <ChoiceTile
          ...
          subtitle={t('settings.buffer_cache_desc')}
          options={[
            { value: '100', label: '100 MB' },
            { value: '500', label: '500 MB' },
            { value: '1000', label: '1 GB' },
            { value: '2000', label: '2 GB' },
            { value: '-1', label: t('settings.buffer_cache_infinite') },
          ]}
          selected={prefs.playerBufferCacheMb}
          onSelect={(v) => setPref('playerBufferCacheMb', v)}
        />
        <ChoiceTile
          title={t('settings.forward_buffer')}
          subtitle={t('settings.forward_buffer_desc')}
          options={[
            { value: '30', label: '30s' },
            { value: '60', label: '60s' },
          ...
          selected={prefs.playerForwardBufferSeconds}
          onSelect={(v) => setPref('playerForwardBufferSeconds', v)}
        />
        <ChoiceTile
          title={t('settings.back_buffer')}
          subtitle={t('settings.back_buffer_desc')}
          options={[
            { value: '0', label: '0s' },
            { value: '15', label: '15s' },
            { value: '30', label: '30s' },
          ...
          selected={prefs.playerBackBufferSeconds}
          onSelect={(v) => setPref('playerBackBufferSeconds', v)}
        />
        <ChoiceTile
      ...
      <SettingsSection title={t('settings.skip_segments')} subtitle={t('settings.use_introdb_desc')}>
        <ToggleTile
          title={t('settings.skip_intro_outro_recap')}
          subtitle={t('settings.skip_intro_outro_recap_desc')}
          checked={prefs.useSkipSegments}
          onToggle={(v) => setPref('useSkipSegments', v)}
        />
        <ToggleTile
          title={t('settings.use_animeskip')}
          subtitle={t('settings.use_animeskip_desc')}
          checked={prefs.useAnimeSkip}
          onToggle={(v) => setPref('useAnimeSkip', v)}
        />
        {prefs.useAnimeSkip && (
          <InputTile
        ...
        <ToggleTile
          title={t('settings.use_chapter_skip')}
          subtitle={t('settings.use_chapter_skip_desc')}
          checked={prefs.useChapterSkip}
          onToggle={(v) => setPref('useChapterSkip', v)}
        />
        {(prefs.useSkipSegments || prefs.useAnimeSkip) && (
          <ToggleTile
            title={t('settings.auto_skip')}
            subtitle={t('settings.auto_skip_desc')}
            checked={prefs.autoSkipIntro}
            onToggle={(v) => setPref('autoSkipIntro', v)}
          />
        )}
        {prefs.useSkipSegments && (
          <ToggleTile
            title={t('settings.introdb_submit')}
            subtitle={t('settings.introdb_submit_desc')}
            checked={prefs.introDbSubmitEnabled}
            onToggle={(v) => setPref('introDbSubmitEnabled', v)}
          />
        )}
        {prefs.useSkipSegments && prefs.introDbSubmitEnabled && (
          <InputTile
        ...
        {prefs.useSkipSegments && (
          <ToggleTile
            title={t('settings.skipdb_submit')}
            subtitle={t('settings.skipdb_submit_desc')}
            checked={prefs.skipDbSubmitEnabled}
            onToggle={(v) => setPref('skipDbSubmitEnabled', v)}
          />
        )}
        {prefs.useSkipSegments && prefs.skipDbSubmitEnabled && (
          <InputTile
        ...
        {prefs.useSkipSegments && (
          <ToggleTile
            title={t('settings.theintrodb_submit')}
            subtitle={t('settings.theintrodb_submit_desc')}
            checked={prefs.theIntroDbSubmitEnabled}
            onToggle={(v) => setPref('theIntroDbSubmitEnabled', v)}
          />
        )}
        {prefs.useSkipSegments && prefs.theIntroDbSubmitEnabled && (
          <InputTile
      ...
      <SettingsSection title={t('settings.preferences')} subtitle={t('settings.preferred_audio_language_desc')}>
        <ChoiceTile
          title={t('settings.audio_processing_mode')}
          subtitle={t('settings.audio_processing_mode_desc')}
          options={[
            { value: 'reference', label: t('settings.audio_processing_reference') },
            { value: 'balanced', label: t('settings.audio_processing_balanced') },
            { value: 'night', label: t('settings.audio_processing_night') },
          ]}
          selected={prefs.audioProcessingMode}
          onSelect={(v) => setPref('audioProcessingMode', v)}
        />
        <ChoiceTile
          title={t('settings.preferred_audio_language')}
          subtitle={t('settings.preferred_audio_language_desc')}
          options={langOptions()}
          selected={prefs.preferredAudioLanguage}
          onSelect={(v) => setPref('preferredAudioLanguage', v)}
        />
        <ChoiceTile
          title={t('settings.secondary_audio_language')}
          subtitle={t('settings.secondary_audio_language_desc')}
          options={langOptions()}
          selected={prefs.secondaryAudioLanguage}
          onSelect={(v) => setPref('secondaryAudioLanguage', v)}
        />
        <ChoiceTile
          title={t('settings.preferred_subtitle_language')}
          subtitle={t('settings.preferred_subtitle_language_desc')}
          options={langOptions()}
          selected={prefs.preferredSubtitleLanguage}
          onSelect={(v) => setPref('preferredSubtitleLanguage', v)}
        />
        <ChoiceTile
          title={t('settings.secondary_subtitle_language')}
          subtitle={t('settings.secondary_subtitle_language_desc')}
          options={langOptions()}
          selected={prefs.secondarySubtitleLanguage}
          onSelect={(v) => setPref('secondarySubtitleLanguage', v)}
        />
        <ToggleTile
          title={t('settings.anime_japanese_audio')}
          subtitle={t('settings.anime_japanese_audio_desc')}
          checked={prefs.animePreferJapaneseAudio}
          onToggle={(v) => setPref('animePreferJapaneseAudio', v)}
        />
      </SettingsSection>
      <SettingsSection title={t('settings.subtitle.customize')} subtitle={t('auto.subtitle_language_size_and_readability')}>
        <ToggleTile
          title={t('auto.auto_enable_subtitles_db2311e6')}
          subtitle={t('auto.enable_subtitles_automatically_when_availabl')}
          checked={prefs.autoEnableSubtitles}
          onToggle={(v) => setPref('autoEnableSubtitles', v)}
        />
        <ChoiceTile
          title={t('settings.subtitle_position')}
          subtitle={t('settings.subtitle_position_desc')}
          options={[
            { value: '100', label: t('settings.subtitle_position_bottom') },
            { value: '90', label: t('settings.subtitle_position_low') },
            { value: '80', label: t('settings.subtitle_position_middle') },
            { value: '70', label: t('settings.subtitle_position_high') },
          ]}
          selected={prefs.subtitlePosition}
          onSelect={(v) => setPref('subtitlePosition', v)}
        />
        <ChoiceTile
          title={t('auto.subtitle_size_7fc78c82')}
          subtitle={t('auto.tune_readability_on_tv_and_mobile')}
          options={[
            { value: '50', label: '50%' },
            { value: '75', label: '75%' },
            { value: '100', label: '100%' },
          ...
          onSelect={(v) => setPref('subtitleSize', v)}
        />
        <ChoiceTile
          title={t('settings.subtitle_text')}
          subtitle={t('settings.subtitle_text_desc')}
          options={[
            { value: '#FFFFFF', label: t('auto.white') },
            { value: '#000000', label: t('auto.black') },
            { value: '#FFE45C', label: t('auto.yellow') },
            { value: '#FF5D5D', label: t('auto.red') },
          ...
          onSelect={(v) => setPref('subtitleColor', v)}
        />
        <ChoiceTile
          title={t('settings.subtitle.outline_opacity')}
          subtitle={t('settings.subtitle_text_desc')}
          options={[
            { value: '1.0', label: '100%' },
            { value: '0.75', label: '75%' },
          ...
          selected={prefs.subtitleTextOpacity}
          onSelect={(v) => setPref('subtitleTextOpacity', v)}
        />
        <ChoiceTile
          title={t('settings.subtitle_background')}
          subtitle={t('settings.subtitle_background_desc')}
          options={[
            { value: '#000000', label: t('auto.black') },
            { value: '#FFFFFF', label: t('auto.white') },
            { value: '#FFE45C', label: t('auto.yellow') },
          ...
          selected={prefs.subtitleBackgroundColor}
          onSelect={(v) => setPref('subtitleBackgroundColor', v)}
        />
        <ChoiceTile
          title={t('auto.background_transparency')}
          subtitle={t('settings.subtitle_background_desc')}
          options={[
            { value: '1.0', label: '100%' },
            { value: '0.75', label: '75%' },
          ...
          selected={prefs.subtitleBackgroundOpacity}
          onSelect={(v) => setPref('subtitleBackgroundOpacity', v)}
        />
        <ChoiceTile
          title={t('settings.subtitle_outline')}
          subtitle={t('settings.subtitle_outline_desc')}
          options={[
            { value: '#000000', label: t('auto.black') },
            { value: '#FFFFFF', label: t('auto.white') },
            { value: '#FFE45C', label: t('auto.yellow') },
          ...
          selected={prefs.subtitleOutlineColor}
          onSelect={(v) => setPref('subtitleOutlineColor', v)}
        />
        <ChoiceTile
          title={t('settings.subtitle.outline_opacity')}
          subtitle={t('settings.subtitle_outline_desc')}
          ...
          selected={prefs.subtitleOutlineOpacity}
          onSelect={(v) => setPref('subtitleOutlineOpacity', v)}
        />
        <ChoiceTile
          title={t('settings.subtitle_outline_size')}
          subtitle={t('settings.subtitle_outline_size_desc')}
          options={[
            { value: '0', label: t('settings.subtitle_outline_none') },
            { value: '1', label: '1' },
            { value: '2', label: '2' },
            { value: '3', label: '3' },
            { value: '4', label: '4' },
          ...
          selected={prefs.subtitleOutlineSize}
          onSelect={(v) => setPref('subtitleOutlineSize', v)}
        />
        <ToggleTile
          title={t('settings.subtitle_bold')}
          subtitle={t('settings.subtitle_bold_desc')}
          checked={prefs.subtitleBold}
          onToggle={(v) => setPref('subtitleBold', v)}
        />
        <ToggleTile
          title={t('settings.subtitle_force_style')}
          subtitle={t('settings.subtitle_force_style_desc')}
          checked={prefs.subtitleForceStyle}
          onToggle={(v) => setPref('subtitleForceStyle', v)}
        />
        <ToggleTile
          title={t('settings.subtitle_shadow') || 'Altyazı Gölgesi'}
          subtitle={t('settings.subtitle_shadow_desc') || 'Altyazı metnine gölge efekti ekle'}
          checked={prefs.subtitleShadow}
          onToggle={(v) => setPref('subtitleShadow', v)}
        />
        <ChoiceTile
