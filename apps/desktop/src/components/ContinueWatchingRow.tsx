...
const cwStyles: Record<string, React.CSSProperties> = {
  ...
  aboutName: { margin: '0.25rem 0 0', color: 'var(--fluxa-text-muted)', fontSize: '0.8125rem', overflowWrap: 'anywhere' },
  aboutClose: {
    flex: '0 0 auto',
    width: '1.875rem',
    height: '1.875rem',
  ...
  aboutLabel: { color: 'var(--fluxa-text-muted)', fontSize: '0.75rem', fontWeight: 600 },
  aboutValue: {
    color: 'var(--fluxa-text-strong)',
    fontSize: '0.75rem',
