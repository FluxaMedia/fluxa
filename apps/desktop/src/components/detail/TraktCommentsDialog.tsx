...
import { color, fade, fontSize, radius, z } from '../../design';
...
const styles: Record<string, React.CSSProperties> = {
  ...
  dialog: {
    ...
    overflow: 'hidden',
    border: `0.0625rem solid ${color.lineStrong}`,
    borderRadius: radius.xl,
    background: color.surface,
    color: color.textPrimary,
    boxShadow: `0 1.5rem 5rem ${fade.shade(0.55)}`,
  },
  header: {
    display: 'flex',
    ...
    borderBottom: `0.0625rem solid ${color.line}`,
  },
  title: { margin: 0, fontSize: fontSize.xl },
  subtitle: { margin: '0.25rem 0 0', color: color.textMuted, fontSize: fontSize.md },
  closeButton: {
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  message: { margin: '1.5rem 0', color: color.textBody, textAlign: 'center' },
  comment: { padding: '1rem 0', borderBottom: `0.0625rem solid ${color.line}` },
  commentHeader: { display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap', fontSize: fontSize.md },
  avatar: { width: '2.25rem', height: '2.25rem', borderRadius: radius.circle, objectFit: 'cover' },
  avatarFallback: {
    width: '2.25rem',
    height: '2.25rem',
    flexShrink: 0,
  ...
  username: { color: color.textMuted, fontSize: fontSize.sm },
  review: {
  ...
  body: { margin: '0.625rem 0 0', color: color.textStrong, lineHeight: 1.55, whiteSpace: 'pre-wrap' },
  commentMeta: {
    display: 'flex',
    flexWrap: 'wrap',
  ...
  profile: { marginTop: '0.75rem', borderRadius: radius.md, overflow: 'hidden', background: color.fill },
  profileSummary: { padding: '0.625rem 0.75rem', cursor: 'pointer', color: color.textStrong, fontSize: fontSize.base },
  ...
  about: { margin: '0 0.75rem 0.75rem', color: color.textBody, fontSize: fontSize.base, lineHeight: 1.45, whiteSpace: 'pre-wrap' },
};
