...
val rustCrateDir = rootProject.layout.projectDirectory.asFile.resolve("../../core/fluxa-core").canonicalFile
val rustStreamingCrateDir = rootProject.layout.projectDirectory.asFile.resolve("../../core/fluxa-core/fluxa-streaming-engine").canonicalFile
    ...
    tasks.register<Exec>(taskName) {
        ...
        doFirst {
            ...
            if (ndkDir.isBlank() || !file(ndkDir).exists()) {
                throw GradleException("Android NDK is required to build ../../core/fluxa-core.")
            }
