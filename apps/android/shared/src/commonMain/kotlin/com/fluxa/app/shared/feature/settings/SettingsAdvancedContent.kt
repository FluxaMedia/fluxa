...
internal fun SettingsAdvancedContent(model: SettingsAdvancedUiModel, lang: String?, onAction: (SettingsAction) -> Unit) {
    ...
    val audioProcessingOptions = listOf(
        SettingsChoiceOption("reference", AppStrings.t(lang, "settings.audio_processing_reference")),
        SettingsChoiceOption("balanced", AppStrings.t(lang, "settings.audio_processing_balanced")),
        SettingsChoiceOption("night", AppStrings.t(lang, "settings.audio_processing_night")),
    )
    ...
    SettingsGroupCard {
        ...
        SettingsChoiceRow(AppStrings.t(lang, "settings.audio_processing_mode"), model.audioProcessingMode, audioProcessingOptions) { onAction(SettingsAction.AdvancedChanged(model.copy(audioProcessingMode = it))) }
