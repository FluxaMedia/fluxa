...
private val SETTINGS_SEARCH_KEYS: List<Pair<String, SettingsCategory>> = listOf(
    ...
    "settings.device_capabilities" to SettingsCategory.DeviceCapabilities,
    "settings.audio_passthrough" to SettingsCategory.DeviceCapabilities,
    "settings.video_decoders" to SettingsCategory.DeviceCapabilities
)
