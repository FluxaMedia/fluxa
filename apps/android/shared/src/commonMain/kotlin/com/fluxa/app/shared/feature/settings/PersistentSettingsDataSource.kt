...
abstract class PersistentSettingsDataSource(
    ...
    override suspend fun updateAdvanced(value: SettingsAdvancedUiModel) {
        ...
        preferences.putString(SettingsPreferenceKeys.AUDIO_PROCESSING_MODE, value.audioProcessingMode)
    ...
    private fun readStoredState(): SettingsUiState {
        ...
        return defaults.copy(
            ...
            advanced = defaults.advanced.copy(
                ...
                audioProcessingMode = preferences.getString(SettingsPreferenceKeys.AUDIO_PROCESSING_MODE, defaults.advanced.audioProcessingMode) ?: defaults.advanced.audioProcessingMode,
...
object SettingsPreferenceKeys {
    ...
    const val AUDIO_PROCESSING_MODE = "audioProcessingMode"
