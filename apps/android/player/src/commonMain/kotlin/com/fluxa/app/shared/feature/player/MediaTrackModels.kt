    ...
    val audioChannelLabel: String
        get() {
            ...
            return when (channelCount) {
                1 -> "Mono"
                2 -> "Stereo"
                // Media3/Android's three-channel PCM ordering is FL, FR, FC
                // (CHANNEL_OUT_SURROUND), which is the layout used by the
                // shared downmix matrix below. Do not label it as 2.1 and
                // imply an LFE channel we cannot identify from channel count.
                3 -> "3.0"
                4 -> "4.0"
                5 -> "5.0"
                6 -> "5.1"
