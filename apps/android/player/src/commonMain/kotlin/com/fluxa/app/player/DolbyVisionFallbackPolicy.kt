...
/**
 * Transport-only Dolby Vision rewriting.
 *
 * Rust owns stream classification, fallback selection, proxy planning and
 * sample/RPU processing. This object intentionally contains only the HLS
 * manifest and container-header mutations that require platform byte access;
 * new playback decisions belong in fluxa-core instead of being duplicated here.
 */
