...
object FluxaStreamingNative {
    ...
    fun startTorrentServer(cacheDir: String, preferredPort: Int): String = call {
        startTorrentServerNative(cacheDir, preferredPort)
    }
    ...
    private external fun startTorrentServerNative(cacheDir: String, preferredPort: Int): String
