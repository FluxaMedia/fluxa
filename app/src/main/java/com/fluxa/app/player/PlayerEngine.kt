...
interface PlayerEngine {
    ...
    val activeVideoFormatBadge: StateFlow<VideoFormatBadge?>
...
class ExoPlayerEngine(
    ...
    override val activeVideoFormatBadge: StateFlow<VideoFormatBadge?> = controller.activeVideoFormatBadge
    ...
    private fun resolveLocalStream(
        ...
        val caps = DolbyVisionFallbackPolicy.capabilities(controller.context)
...
class MpvPlayerEngine(
    ...
    override val activeVideoFormatBadge: StateFlow<VideoFormatBadge?> = MutableStateFlow(null)
