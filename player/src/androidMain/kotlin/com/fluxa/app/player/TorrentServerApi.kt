...
interface TorrentServerApi {
    ...
    @POST("torrents")
    suspend fun addTorrent(@Body request: TorrentRequest): Response<AndroidTorrentStatus>

    @POST("torrents")
    suspend fun getTorrent(@Body request: TorrentRequest): Response<AndroidTorrentStatus>

    @POST("torrents")
    suspend fun removeTorrent(@Body request: TorrentRequest): Response<Unit>

    //  Legacy (Classic) @POST("torrent/add")
    suspend fun addTorrentLegacy(@Body request: TorrentAddRequest): Response<AndroidTorrentStatus>

    @POST("torrent/get")
    suspend fun getTorrentLegacy(@Body request: String): Response<AndroidTorrentStatus>
