...
export const heroStyles: Record<string, React.CSSProperties> = {
  ...
  gradientTop: {
    position: 'absolute',
    inset: 0,
    background: 'linear-gradient(to bottom, rgba(6,6,6,0.55) 0%, rgba(6,6,6,0.20) 12%, rgba(6,6,6,0.00) 28%)',
    pointerEvents: 'none',
    zIndex: 1,
  },
  gradientLeft: {
  ...
  gradientBottom: {
    ...
    bottom: 0,
    height: '7.5rem',
    background: 'linear-gradient(to bottom, rgba(6,6,6,0.00) 55%, #060606 100%)',
    pointerEvents: 'none',
    zIndex: 1,
  },
  panel: {
