...
export function usePlayerTitleReset({
  setTitle,
  setEpisodeTitle,
  setAbLoopStage,
  setNextEpisodeDismissed,
  autoSkippedKeysRef,
  stallCountRef,
  ...
  setEpisodeTitle: Dispatch<SetStateAction<string>>;
  setAbLoopStage: Dispatch<SetStateAction<'none' | 'a' | 'ab'>>;
  setNextEpisodeDismissed: Dispatch<SetStateAction<boolean>>;
  ...
  networkHistoryRef: MutableRefObject<number[]>;
