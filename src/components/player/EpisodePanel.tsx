        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          {seasons.length > 1 && (
            <div style={{ position: 'relative' }}>
              ...
              <Popover
                open={showSeasonDropdown}
                onClose={() => setShowSeasonDropdown(false)}
                ...
                {seasons.map((s) => (
                  <button
                    ...
                    style={{
                      display: 'block',
                      width: '100%',
                      background: s === activeSeason ? 'rgba(255,255,255,0.08)' : 'none',
                      border: 'none',
                      color: s === activeSeason ? '#fff' : 'rgba(255,255,255,0.65)',
                      fontSize: '0.75rem',
                      fontWeight: s === activeSeason ? 700 : 400,
          ...
          <button onClick={onClose} style={{ ...iconBtn, width: '2rem', height: '2rem', opacity: 0.6 }}>
            ✕
          </button>
        </div>
      </div>
