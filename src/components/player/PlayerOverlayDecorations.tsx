...
export function PlayerOverlayDecorations({
  controlsVisible,
  feedback,
  muted,
  volumeLevel,
  ...
  feedback: FeedbackFlash | null;
  muted: boolean;
  volumeLevel: number;
  showSeekOverlay: boolean;
  activeSkip: ActiveSkip | null;
  showNextEpCard: boolean;
  nextEpSubtitle: string | null;
  nextEpThumbnail: string | null;
        ...
        >
          <div
            style={{
              ...
              animation: 'fluxa-seek-spin 0.75s linear infinite',
            }}
          />
        </div>
      )}
