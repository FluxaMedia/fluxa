        ...
        {seasonWatched && (
          <span style={{ display: 'flex', alignItems: 'center', marginLeft: 2 }}>
            {selectedIsWatched ? (
              ...
              <svg width="18" height="18" viewBox="0 0 24 24" fill="rgba(255,255,255,0.35)"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></svg>
            )}
          </span>
        )}
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" style={{ transform: open ? 'rotate(180deg)' : 'none', transition: 'transform 0.2s' }}>
          ...
          {seasons.map((s) => {
            ...
            return (
              ...
              >
                ...
                {isWatched ? (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="rgba(255,255,255,0.85)" style={{ flexShrink: 0 }}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>
                ) : (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="rgba(255,255,255,0.3)" style={{ flexShrink: 0 }}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"/></svg>
                )}
              </button>
            );
          })}
  ...
  return (
    <div style={EP.panel}>
      <div style={EP.seasonNav}>
        ...
        <SeasonDropdown seasons={seasons} selected={selectedSeason} onChange={onSeasonChange} />
        <button
