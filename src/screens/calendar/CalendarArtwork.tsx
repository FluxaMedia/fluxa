...
export function CalendarArtwork({ src, fallbackSrc, style, fallback = null }: { src?: string; fallbackSrc?: string; style: CSSProperties; fallback?: ReactNode }) {
  ...
  return <img key={displaySrc} src={displaySrc} alt="" style={style} onError={() => setCurrentSrc((previous) => previous === fallbackSrc ? undefined : fallbackSrc)} />;
}
