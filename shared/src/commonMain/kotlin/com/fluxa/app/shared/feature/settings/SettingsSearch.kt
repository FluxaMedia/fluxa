...
private val SETTINGS_SEARCH_KEYS: List<Pair<String, SettingsCategory>> = listOf(
    ...
    "settings.continue_watching_source" to SettingsCategory.AppearanceHome,
    "settings.appearance_detail_screen" to SettingsCategory.AppearanceDetail,
    "settings.detail_screen_style" to SettingsCategory.AppearanceDetail,
    "settings.detail_prefer_clearlogo" to SettingsCategory.AppearanceDetail,
    "settings.detail_episode_descriptions" to SettingsCategory.AppearanceDetail,
    "settings.detail_show_cast" to SettingsCategory.AppearanceDetail,
    "settings.detail_show_recommendations" to SettingsCategory.AppearanceDetail,
    "settings.trailer_on_detail_hero" to SettingsCategory.AppearanceDetail,
    "settings.blur_unwatched_episodes" to SettingsCategory.AppearanceDetail,
    "settings.season_selector" to SettingsCategory.AppearanceDetail,
    "settings.episode_cards_layout" to SettingsCategory.AppearanceDetail,
    ...
    "settings.external_player" to SettingsCategory.Playback,
    "settings.external_player_app" to SettingsCategory.Playback,
    "settings.external_player_custom_command" to SettingsCategory.Playback,
    ...
    "settings.use_skip_segments" to SettingsCategory.Playback,
